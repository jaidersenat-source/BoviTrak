<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        {{-- Aviso: al menos una sección --}}
        <div class="bg-blue-50 border-l-4 border-blue-400 rounded-lg p-4 mb-6 flex items-start gap-3">
            <svg class="w-5 h-5 text-blue-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
            </svg>
            <p class="text-sm text-blue-700">
                Puedes registrar <strong>Lavado</strong>, <strong>Purga</strong> o <strong>ambos</strong> en el mismo registro.
                Al menos una sección debe estar completa.
            </p>
        </div>
