<x-app-layout>
    <x-slot name="title">Editar Proceso Reproductivo – {{ $animal->nombre ?? $animal->codigo_nfc }}</x-slot>
    <x-slot name="header">
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div class="p-6">
                @include('admin.reproductivo.form', [
                    ...
                    'action'       => route('animals.reproductive.update', [$animal, $reproductive]),
                    'method'       => 'PUT',
                ])
            </div>
        </div>
